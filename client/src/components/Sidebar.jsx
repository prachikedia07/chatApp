      ...
      <div className="pb-2">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="relative py-2">
            <EllipsisVertical
              className="text-button dark:text-gray-100 cursor-pointer"
              onClick={(e) => {
            ...
            {isMenuOpen && (
              <div
                className="absolute right-0 top-full mt-1 bg-[var(--bg-glass)]
                           border border-[var(--border)] text-[var(--text-primary)]
                           p-4 rounded-md z-[9999] w-32 backdrop-blur-md shadow-lg"
              >
                <p
                  onClick={() => {
                    navigate("/profile");
